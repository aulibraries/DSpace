...
public class ResourcePolicy
{
    ...
    {        
        ...
        {
            sd = new DateTime(getStartDate());
        }
        
        if(getEndDate() != null)
        {
            ed = new DateTime(getEndDate());
        }
        
        // if an end and start date are not set then 
