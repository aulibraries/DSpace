...
public interface AuthorizeService {
    ...
    /**
     * Is access to the DSpace Object restricted to authenticated users who
     * are members of the Auburn_All users.
     * @param c
     * @param o
     *          the dspace object
     * @return {@code true} if access to the given object or its parent object is restricted
     * to authenticated Auburn users.
     * @throws SQLException if databae error
     */
    public boolean isAccessRestrictedToNonAdminAuburnUsers(Context c, DSpaceObject o) throws SQLException;

    /**
     * Is access to the DSpace object restricted to all non-admin authenticated users.
     * 
     * @param c
     *          current context
     * @param o
