...
public class XOAI {
    ...
    private int index(Date last) throws DSpaceSolrIndexerException {
        ...
        try {
            ...
            return this.index(discoverableChangedItems, 3) + this.index(nonDiscoverableChangedItems, 4)
                    + this.index(possiblyChangedItems, 5);
    ...
    private int indexAll() throws DSpaceSolrIndexerException {
        ...
        try {
            ...
            System.out.println("Indexing discoverable items.");
            ...
            return this.index(discoverableItems, 1) + this.index(nonDiscoverableItems, 2);
        } catch (SQLException ex) {
            throw new DSpaceSolrIndexerException(ex.getMessage(), ex);
        }
    }
    ...
    private int index(Iterator<Item> iterator, int itemType) throws DSpaceSolrIndexerException {
        try {
            int i = 0;
            ...
            switch(itemType) {
                case 1:
                    ...
                    break;
                case 2:
                    out += "non discoverable";
                    break;
                case 3:
                    out += "discoverable changed";
                    break;
                case 4:
                    out += "non discoverable changed";
                    break;
                case 5:
                    out += "discoverable possibly changed";
                default:
                    break;
            }
            
            System.out.println(out + " items: " + i);
            server.commit();
            return i;
