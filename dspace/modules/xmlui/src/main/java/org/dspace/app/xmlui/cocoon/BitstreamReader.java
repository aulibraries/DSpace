...
{
    private static final Logger log = Logger.getLogger(BitstreamReader.class);
    ...
    // Custom Constant
    private static final String AUTH_REQUIRED_MESSAGE_NOLOGIN = "xmlui.BitstreamReader.auth_message_nologin";
        ...
        throws ProcessingException, SAXException, IOException
    {
        ...
        try
        {
            ...
            log.debug(LogManager.getHeader(context, "Authorize Info", " isAuthorized = "+String.valueOf(isAuthorized)));
            ...
            if (!isAuthorized)
            {
                ...
                else
                {
                    if(StringUtils.isBlank(requestItemType) || "logged".equalsIgnoreCase(requestItemType))
                    {
                        ...
                        if(EmbargoManager.getEmbargoRightsMDV(context, item).equals(ETDEmbargoSetter.EMBARGO_NOT_AUBURN_STR))
                        {
            ...
            log.debug(LogManager.getHeader(context, "Authorize Info", " isAnonymouslyReadable = "+String.valueOf(this.isAnonymouslyReadable)));
            ...
            new DSpace().getEventService().fireEvent(new UsageEvent(UsageEvent.Action.VIEW,
