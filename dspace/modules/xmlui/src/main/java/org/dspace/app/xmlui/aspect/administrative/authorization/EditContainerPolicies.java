...
{	
    ...
    /**
     * AUETD Custom Constant Messages
     */
    private static final Message AUETD_T_head_action =
        message("xmlui.administrative.authorization.EditContainerPolicies.AUETD_head_action");
	...
	public void addBody(Body body) throws WingException, SQLException 
	{
        ...
        header.addCell().addContent(AUETD_T_head_action);
