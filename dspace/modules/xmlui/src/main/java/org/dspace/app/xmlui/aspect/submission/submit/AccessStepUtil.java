...
//        }
    ...
    public int getEmbargoLengthNYears(ResourcePolicy resourcePolicy)
        throws AuthorizeException, IOException, SQLException
    {
        if(resourcePolicy.getStartDate()!=null)
        {
            return Years.yearsBetween(DateTime.now(), new DateTime(resourcePolicy.getStartDate())).getYears()+1;
        }
