...
package org.dspace.objectmanager;
...
public abstract class AbstractAdapter
{
     ...
     */
    public static final String[] METS_DEFINED_TYPES = {"MARC","MODS","EAD","DC","NISOIMG","LC-AV","VRA","TEIHDR","DDI","FGDC","PREMIS"/*,"OTHER"*/};
     ...
     * @throws org.xml.sax.SAXException
     */
    protected final void startElement(Namespace namespace, String name, AttributeMap... attributes)
        throws SAXException
    {
    ...
    private AttributesImpl map2sax(Namespace elementNamespace, AttributeMap ... attributeMaps)
    {
        ...
        for (AttributeMap attributeMap : attributeMaps)
        {
            ...
            for (Map.Entry<String, String> attr : attributeMap.entrySet())
            {
                ...
                {
                    attributes.addAttribute(attributeNamespace.URI, attr.getKey(), qName(attributeNamespace, attr.getKey()), "CDATA", attr.getValue());
                }
                else
                {
