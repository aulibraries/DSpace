...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
	...
	<xsl:import href="aspect/administrative/control-panel.xsl"/>
	<xsl:import href="aspect/administrative/item-editing.xsl"/>
	...
	<xsl:import href="aspect/submission/file-upload.xsl"/>
	<xsl:import href="aspect/submission/license.xsl"/>
