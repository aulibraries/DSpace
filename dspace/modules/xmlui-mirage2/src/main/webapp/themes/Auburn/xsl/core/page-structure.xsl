        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    <xsl:text>//www.auburn.edu/template/images/favicon.ico</xsl:text>
                </xsl:attribute>
            </link>
    ...
    <xsl:template name="specialMessage">
        <div class="row submissionMsgRow">
            <div class="col-lg-12">
                ...
                <p>Auburn University students are to submit their thesis or dissertation through this AUETD system. The Auburn University Graduate School handles the processing of submissions to the AUETD system. For questions about the status of your thesis or dissertation in AUETD, please contact the Graduate School at <a title="Email the Graduate School" href="mailto:etdhelp@auburn.edu">etdhelp@auburn.edu</a>.</p>
            </div>
        </div>
