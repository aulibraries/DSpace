    ...
    <xsl:template name="specialMessage">
        <div class="row submissionMsgRow">
            <div class="col-lg-12">
                ...
                <p>The Auburn University Graduate School handles submissions to the AUETD system. For information on how to submit your thesis or dissertation, please consult the Graduate School's <a target="_blank" title="Thesis and Dissertation Guide" href="http://www.grad.auburn.edu/etd_guide.html">Thesis and Dissertation Guide</a>. For questions about the status of your thesis or dissertation in AUETD, please contact the Graduate School at <a title="Email the Graduate School" href="mailto:etdhelp@auburn.edu">etdhelp@auburn.edu</a>.</p>
