...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
					<xsl:text>//cdn.auburn.edu/assets/ico/favicon.png</xsl:text>
                </xsl:attribute>
            </link>
                    ...
                    <div class="col-xs-12">
                        <xsl:choose>
                            <xsl:when test="count(/dri:document/dri:meta/dri:pageMeta/dri:trail) > 1">
                                ...
                                <ul class="breadcrumb hidden-xs hidden-print">
    ...
    <xsl:template name="buildFooter">
        <footer>
			...
			<p><span><a href="https://www.auburn.edu/websitefeedback/">Website Feedback</a> |</span> <span><a href="https://www.auburn.edu/privacy/"> Privacy</a> |</span> <span><a href="https://www.auburn.edu/oit/it_policies/copyright_regulations.php"> Copyright &#169; <script type="text/javascript">date = new Date(); document.write(date.getFullYear());</script></a></span></p>
    ...
    <xsl:template name="addJavascript">
		...
		<script src="{concat($theme-path, 'scripts/bootstrap-filestyle.min.js')}">&#160;</script>
		<script src="{concat($theme-path, 'scripts/application.js')}">&#160;</script> -->
