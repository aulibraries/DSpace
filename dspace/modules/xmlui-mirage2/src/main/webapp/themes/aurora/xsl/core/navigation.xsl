...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="searchFormBlock">
        <div class="ds-option-set col-sm-12 list-group" id="ds-search-option">
            ...
            <form id="ds-search-form" class="" method="post">
                ...
                <fieldset>
                    <div class="input-group">
                        <input class="ds-text-field form-control" type="text" placeholder="xmlui.general.search.placeholder.aurora_placeholder" i18n:attr="placeholder">
                            <xsl:attribute name="name">
                                <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='search'][@qualifier='queryField']"/>
                            </xsl:attribute>
                        </input>
                        <span class="input-group-btn">
                            <button class="ds-button-field btn btn-default" title="Search" i18n:attr="title">
    ...
    <xsl:template match="dri:options/dri:list[not(@id='aspect.viewArtifacts.Navigation.list.account')]" priority="3">
    ...
    <xsl:template match="dri:options/dri:list/dri:head" mode="optionHead" priority="3">
