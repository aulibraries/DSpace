    ...
    <xsl:template name="itemSummaryView-DIM-abstract">
        <xsl:if test="dim:field[@element='description' and @qualifier='abstract']">
            <div class="simple-item-view-description item-page-field-wrapper table">
                <h2 class="visible-xs h5"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-abstract</i18n:text></h2>
                <div>
    ...
    <xsl:template name="itemSummaryView-DIM-authors">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='author' and descendant::text()] or dim:field[@element='creator' and descendant::text()] or dim:field[@element='contributor' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper table">
                <h2 class="h5"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-author</i18n:text></h2>
                <xsl:choose>
    ...
    <xsl:template name="itemSummaryView-DIM-URI">
        <xsl:if test="dim:field[@element='identifier' and @qualifier='uri' and descendant::text()]">
            <div class="simple-item-view-uri item-page-field-wrapper table">
                <h2 class="h5"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-uri</i18n:text></h2>
                <span>
            ...
            <a>
                ...
                <xsl:attribute name="aria-label">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:text>Download </xsl:text> <xsl:value-of select="mets:FLocat[@LOCTYPE='URL']/@xlink:title"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:attribute>
   ...
   <xsl:template match="mets:fileGrp[@USE='CONTENT']">
    ...
    <xsl:template match="mets:file">
        ...
        <div class="file-wrapper row">
            ...
            <div class="col-xs-2 col-sm-2 hidden-xs hidden-sm">
                <xsl:call-template name="getFileIcon">
                    <xsl:with-param name="mimetype">
                        <xsl:value-of select="substring-after(@MIMETYPE,'/')"/>
                    </xsl:with-param>
                ...
                <!--<a>
                        ...
                        <xsl:attribute name="class">
                         ...
                         <img class="img-thumbnail" alt="Thumbnail">
                            <xsl:attribute name="src">
                                <xsl:value-of select="concat($theme-path, 'images/pdf-icon.png')"/>
                            </xsl:attribute>
                        </img> -->
                <!-- </a> -->
            </div>
